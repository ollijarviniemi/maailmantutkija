/**
 * Level Registry for Todennakoisyysmallit
 *
...
const LevelRegistry = {
  GAME_NAME: 'tehdas-simulointi',

  GROUP_NAMES: ['Sekoitin', 'Silmukat', 'Jakauma', 'Monta palloa', 'Monistaja', 'Katkaisin', 'Other'],

  GROUP_DESCRIPTIONS: [
    'Tasoja, joissa on vain sekoittimia.',
    'Liukuhihnat ja sekoittimet muodostavat silmukoita.',
    'Todennäköisyys annetaan jokaiselle laatikolle.',
    'Tehtaalla liikkuu useampi pallo.',
    'Tasoja, joissa palloja monistetaan.',
    null, null
  ],
