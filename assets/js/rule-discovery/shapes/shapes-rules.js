...
export const SHAPES_RULES = [
    ...
    {
        id: 's14',
        name: 'Keskimmäiset ovat samaa väriä ja reunimmaiset ovat samaa väriä',
        check: (shapes) => shapes[0].color === shapes[3].color && shapes[1].color === shapes[2].color,
        distribution: {
            positive: [
                { type: 'symmetricColors', weight: 1.0 }
            ],
            negative: BASELINE_DISTRIBUTION // Baseline includes palindromes, first-last-same, and random patterns
        },
